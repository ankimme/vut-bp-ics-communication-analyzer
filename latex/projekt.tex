...
\projectinfo{
  ...
  title.cs={Aplikace pro statistickou analýzu ICS komunikace},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  title.en={Application for Statistical Analysis of ICS Communication}, % název práce v angličtině / thesis title in english
  ...
  %Autor / Author
  author.name={Andrea},   % jméno autora / author name
  author.surname={Chimenti},   % příjmení autora / author surname 
